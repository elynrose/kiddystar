        ...
        try {
            ...
            foreach ($conditions as $condition) {
                ...
                if (isset($this->options['withoutGlobalScopes']) && $this->options['withoutGlobalScopes']) {
                    ...
                    $collection = $query->withoutGlobalScopes($scopesToExclude)->where('card_id',  $this->options['card_id'])->get();
                } else {
                    $collection = $query->where('card_id',  $this->options['card_id'])->get();
                }
