            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.rewards.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="required" for="points">{{ trans('cruds.reward.fields.points') }}: <span id="points_text"></span></label>
                            <input class="form-control" type="hidden" name="points" id="points" value="{{ old('points', '') }}" step="1" required>
