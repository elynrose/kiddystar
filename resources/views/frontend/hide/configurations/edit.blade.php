                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.configurations.update", [$configuration->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="message" id="message" value="{{ old('message', $configuration->message) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $configuration->start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="points_per_dollar" id="points_per_dollar" value="{{ old('points_per_dollar', $configuration->points_per_dollar) }}" step="0.01">
