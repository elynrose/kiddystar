                    ...
                    <div class="col-md-12 search-item">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                @foreach($task->assigned_tos as $assigned)
                                <a href="{{ route('frontend.completed')}}" data-task="{{$task->id}}" data-child="{{$assigned->pivot->child_id}}" class="btn btn-default btn-sm done"><i class="fas fa-star yellow"></i>  {{ $assigned->first_name }}  </a>
                                    @endforeach
                                    @can('task_edit')
