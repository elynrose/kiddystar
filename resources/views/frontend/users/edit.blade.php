                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="partner_email" id="partner_email" value="{{ old('partner_email', $user->partner_email) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" name="partner_password" id="partner_password">
