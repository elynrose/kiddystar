...
class CompletedController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.completeds.index', compact('completeds'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.completeds.create', compact('children', 'tasks'));
    }
    ...
    public function store(StoreCompletedRequest $request)
    {
        ...
        return redirect()->route('frontend.completeds.index');
    }
    ...
    public function edit(Completed $completed)
    {
        ...
        return view('frontend.completeds.edit', compact('children', 'completed', 'tasks'));
    }
    ...
    public function show(Completed $completed)
    {
        ...
        return view('frontend.completeds.show', compact('completed'));
    }
